...
model_list     = ['sparsenet', 'mlp']
version_list   = [80, 90, 95, 99]
iteration_list = range(10000,50001,10000)
model_num      = 3
...
print model_list[0]+" lbl err: "+str(lbl_err[0,:])
print model_list[1]+" lbl err: "+str(lbl_err[1,:])
print "\n"
print model_list[0]+" itr err: "+str(itr_err[0,:])
print model_list[1]+" itr err: "+str(itr_err[1,:])

plt.figure(1)
plt.plot(version_list, lbl_err[0,:], 'r', label='SA')
plt.plot(version_list, lbl_err[1,:], 'b', label='MLP')
...
plt.figure(2)
plt.plot(iteration_list, itr_err[0,:], 'r', label='SA')
plt.plot(iteration_list, itr_err[1,:], 'b', label='MLP')
